...
class AdjustFeedsPage(Page):
    def __init__(self, *args, **kwargs):
        ...
        bump_button = tk.Button(bump_frame, text = 'Bump', command = backend.bump_feed)
        ...
        fine_button = tk.Button(fine_frame, text = 'Fine', command = backend.fine_feed)
        ...
        coarse_button = tk.Button(coarse_frame, text = 'Coarse', command = backend.coarse_feed)
